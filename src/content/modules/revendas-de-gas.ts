      ...
      features: [
        {
          ...
          screenshotPath: '/screenshots/features/carregamentos.png',
          icon: 'truck',
        },
        {
          id: 'vasilhames',
          ...
          screenshotPath: '/screenshots/features/vasilhames.png',
          icon: 'cylinder',
        },
        {
          ...
          screenshotPath: '/screenshots/features/acerto-do-entregador.png',
          icon: 'calculator',
        ...
        },
        {
          ...
          screenshotPath: '/screenshots/features/app-do-entregador.png',
          icon: 'smartphone',
    ...
    },
    {
      ...
      features: [
        ...
        },
        {
          ...
          screenshotPath: '/screenshots/features/distribuicao-de-rotas.png',
          icon: 'map',
        },
        {
          id: 'areas-e-horarios',
          ...
          screenshotPath: '/screenshots/features/areas-e-horarios.png',
          icon: 'map-pinned',
        },
        {
          id: 'tipos-de-entrega',
          ...
          screenshotPath: '/screenshots/features/tipos-de-entrega.png',
          icon: 'sliders',
        },
      ],
    },
      ...
      features: [
        {
          ...
          screenshotPath: '/screenshots/features/escala-e-penalidades.png',
        ...
        },
        {
          ...
          screenshotPath: '/screenshots/features/frota-e-combustivel.png',
          icon: 'wrench',
        ...
        },
        {
          ...
          screenshotPath: '/screenshots/features/brindes-e-promocoes.png',
          icon: 'gift',
        },
        {
          id: 'suporte-tecnico',
          ...
          screenshotPath: '/screenshots/features/suporte-tecnico.png',
          icon: 'wrench',
        },
      ],
    },
