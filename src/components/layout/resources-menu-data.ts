...
export const RESOURCES_TABS: MenuTab[] = [
  {
    ...
    features: [
      ...
      { name: 'Notificações WhatsApp', description: 'Pedido, pagamento, saída, entregue, cancelado.', icon: 'bell', href: '/recursos/essencial' },
      { name: 'App do Entregador', description: 'Carregamentos, transferências, acerto, escala.', icon: 'truck', href: '/recursos/essencial' },
  ...
  },
  {
    ...
    features: [
      ...
      { name: '+30 Relatórios', description: 'Estoque, Vendas, Financeiro, Marketing — em um só lugar.', icon: 'bar-chart-3', href: '/recursos/gestao' },
    ],
  },
  {
    id: 'fiscal',
  ...
  },
  {
    ...
    features: [
      ...
      { name: 'PABX em Nuvem', description: 'Bina, gravação, scoring por IA, URA.', icon: 'phone', href: '/recursos/tech-ia' },
